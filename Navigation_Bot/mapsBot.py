...
class MapsBot:
    ...
    def get_route_info(self):
        ...
        try:
            ...
            if not elements:
                print("[ERROR] get_route_info: маршруты не найдены.")
                return []
            ...
            for element in elements:
                try:
                    ...
                    print("[WARN] get_route_info: маршрут найден, но данные не извлечены.")

            if not routes:
                print(f"[INFO] Найдено {len(routes)} маршрутов: {routes}")
            else:
                print("[ERROR] get_route_info: не удалось извлечь маршруты.")
        ...
        try:
            ...
            for car in data:
                ...
                if not (start_coords and destination_address and unload_datetime):
                    print(f"[WARN] Пропуск машины {car.get('ТС')}: некорректные данные")
                    continue
