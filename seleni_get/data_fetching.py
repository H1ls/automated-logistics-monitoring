...
"""
    ...
    Функция ищет строки, где значение в определенном столбце (задается индексом_столбца) не «Готов» или столбец не существует,
    извлекает и форматирует соответствующую информацию.
    Parameters:
       – None
    Returns:
       – None
